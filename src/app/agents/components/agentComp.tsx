    ...
    return (
        <div className={"mx-auto grid md:grid-cols-2"}>
            {agent ? (<>
                ...
                <div className={"p-4 text-center flex flex-col col-span-1 justify-between items-center md:mt-0 -mt-[3.85rem] -ml-0 md:-ml-16 -z-50"}>
                ...
                <div className={"text-white col-span-1 max-w-[50vh] max-h-[50vh] text-center overflow-y-auto md:-mr-4 p-4 pl-4"}>
                        <Suspense fallback={<Spin/>}>
